...
export function TrackCard({ track, isPlaying, onPlayPause }: TrackCardProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 rounded-lg bg-card hover:bg-accent/50 transition-colors">
      ...
      <div className="flex flex-wrap gap-2 items-center w-full sm:w-auto mt-2 sm:mt-0 pl-12 sm:pl-0">
